...
conv2d: (20 filters, kernel size: 5x5):
   ...
   - Parameters: (20 filters * (5*5) kernel size * 1 inputkanaal ) + 20 bias  = 520
   - Operaties per filter: 5x5x1 = 25
   - Operaties per output pixel: 25x20 = 500
   - Totaal aantal operaties: 24x24x500 = 288.000 
...
conv2d_1 (20 filters, kernel size: 3x3):
   ...
   - Parameters: (20 filters * (3x3) kernel_size * 20 inputkanalen ) + 20 bias = 3.620
   - Operaties per filter: 3x3x20 = 180
   - Operaties per output pixel: 180x20 = 3.600
   - Totaal aantal operaties: 10x10x3600 = 360.000
...
conv2d_2 (20 filters, kernel size: 5x5):
   - Input shape: (None, 5, 5, 20)
   - Output shape: (None, 1, 1, 10)
   - Parameters: (10 filters * (5x5) kernel_size * 20 inputkanalen ) + 10 bias = 5.010
   - Operaties per filter: 5x5x20 = 500
   - Operaties per output pixel: 500x10 = 5.000
   - Totaal aantal operaties: 1x1x5.000 = 5.000
